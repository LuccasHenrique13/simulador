...
<div className="button-container">
    ...
    >
        <img
            className="Sirv image-main" id="pisoteto"
            src={pisotetoBlue}
                            ...
                            <>
                                ...
                                <div className="modal">
                                    ...
                                    <div className="inputOptionsModal">
                                        ...
                                        />
                                        <h1 className="text-blue-600 font-bold text-base">
                                            BTU/h
                                        </h1>
                                    </div>
                                </div>
    ...
    <h1 className="titleBottom" id="titleBottomModelo">Modelo:</h1>
    <div className="buttonOpModal">
        <div className="optionsModal">
            <button
                className="buttonModal"
                onClick={() => handleSwitchSection("generic")}
            >
                <h1 className="titleButtonModal" id="marginButton">
                    GENÉRICO
                </h1>
                <div className="textContainer">
                    <p className="textButtonModal">
                        Ao selecionar o modelo “Genérico” o sistema utilizará como
                        parametros técnicos as médias dos consumos dos aparelhos
                        obtidos de “Marca X Capacidade”.
                    </p>
                </div>
            </button>
            <button
                className="buttonModal2"
                onClick={() => handleSwitchSection("advanced")}
            >
                ...
                <div className="textContainer">
                    <p className="textButtonModal">
                        Ao selecionar “Avançado” você deverá informar o
                        código de modelo do seu aparelho.
                    </p>
                </div>
            </button>
            <button
                className="buttonModal3"
                onClick={() => handleSwitchSection("custom")}
            >
                <h1 className="titleButtonModal">
                    PERSONALIZADO
                </h1>
                <div className="textContainer">
                    <p className="textButtonModal">
                        Ao selecionar “Personalizado” você deverá
                        inserir algumas informações técnicas do aparelho.
                    </p>
                </div>
            </button>
        </div>
